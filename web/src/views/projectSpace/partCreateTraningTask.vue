 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-23 16:33:13
  ...
  <div class="views-personal">
    ...
    >
      ...
      <div class="views-develop-inf views-model-image">
        ...
        <!-- caffe运行参数-->
        <div
          class="views-develop-image  views-caffe-required"
          v-if="caffe_show"
        >
          <el-form-item
          ...
          >
            ...
            >
              <div class="views-develop-choice">
                ...
                <span class="views-btn-reduce " @click="reduceAddress(index)"
                  >—</span
                >
              </div>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getPracticeparam() {
      let obj = {
        project_id: this.$route.query.partId
      };
