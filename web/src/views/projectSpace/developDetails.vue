 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-06 16:31:48
  ...
  <div class="views-personal">
    ...
    <table class="views-project-details views-tabel-details">
      <tr>
        ...
        <td>
          <a :href="devBasic.notebook_url" target="_blank">
    ...
    <div class="views-table-fn">
      <div v-if="mount.length === 0">
        <div slot="empty">
      ...
      <div
        v-for="(item, index) in mount"
        :key="index"
        v-else
        class="views-table-item"
      >
        <div v-for="(value, key) in item" :key="key" class="views-table-key">
          <span class="views-basic-span1">
            {{ key }}
          </span>
          <span>{{ value }}</span>
        </div>
    ...
    <table class="views-project-details views-tabel-details">
      ...
      <tr>
        ...
        <td colspan="3" class="views-basic-color3">
          {{ devBasic.memory }}&nbsp;G
        </td>
      </tr>
    </table>
    ...
    <div class="views-charts-mt">
      ...
      <sedu-echarts
        v-if="JSON.stringify(resourcesUseData) !== '{}'"
        domId="developUse"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogCancel('ruleForm')" class="cancel"
          >取 消</el-button
        >
        <el-button
          type="primary"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="remarksCancel('ruleForm')" class="cancel"
          >取 消</el-button
        >
        <el-button
          type="primary"
    ...
    getDevelopmentDetails(obj) {
      this.$get("/environmentproject/environmentdetail", obj).then(res => {
        ...
        if (res.code === 200) {
          ...
          delete mountData.keyFileName;
          delete mountData.keyFile;
          if (mountData === null) {
            this.mount = [];
          } else {
            this.mount = [];
