  ...
  <div>
    ...
    <div class="views-development">
      ...
      <el-tabs v-model="activeName"
        ...
        <!-- 开发环境 -->
        <el-tab-pane :label="$t('views.development.development')"
                     name="first">
          <views-develop-content></views-develop-content>
        </el-tab-pane>
        <!-- 训练任务 -->
        <el-tab-pane :label="$t('views.trainingTask.trainingTask')"
                     name="second">
          <views-training-task></views-training-task>
        </el-tab-pane>
        <!--  模型预测-->
        <el-tab-pane :label="$t('views.modelPrediction.modelPrediction')"
                     name="third">
