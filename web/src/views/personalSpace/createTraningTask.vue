 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-23 16:34:22
      ...
      <div class="views-task-type ">
        <div class="views-task-right views-task-border ">
          ...
          >
            ...
            >
              <el-option
                v-for="item in personalconfig.cpu_config"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              >
            ...
            >
              <el-option
                v-for="item in personalconfig.gpu_config"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              >
          ...
          <div class="views-task-tensorflow" v-show="tensorflow_show">
            ...
            <div class="views-task-node ">
              ...
              <div class="views-task-sitting views-task-select ">
                ...
                >
                  <el-option
                    v-for="item in personalconfig.memory_config"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                  >
...
export default {
  ...
  methods: {
    ...
    choiceCaffe(arr, index, projectpath, str) {
      ...
      console.log(JSON.stringify(this.postCaffe));
      arr.forEach((item, i) => {
        item.dialogCode = false;
        item.isFirst = false;
        item.isSecond = false;
