  ...
  <div class="views-cluster-monitoring-node-control-detail">
    ...
    <div class="item">
      ...
      <el-table class="tab-content"
        ...
        <el-table-column prop="restart_times"
                         width="100"
                         show-overflow-tooltip
                         align="center"
...
export default {
  ...
  created () {
    ...
    this.$get('/cluster/computerinfo', {instance: this.$route.query.nodeId}).then(data => {
      ...
      this.cpu.data = data.data.allocatedResources.cpuCapacity
      ...
      this.memory.data = (data.data.allocatedResources.memoryCapacity / Math.pow(1024, 2)).toFixed(2)
      let cpuLimits = (data.data.allocatedResources.memoryLimits / Math.pow(1024, 2)).toFixed(2)
      let cpuRequests = (data.data.allocatedResources.memoryRequests / Math.pow(1024, 2)).toFixed(2)
