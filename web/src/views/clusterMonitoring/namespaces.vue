 ...
 * @LastEditors: renlei
 * @LastEditTime: 2020-06-01 15:30:54
 * @Description:命名空间
-->
...
<template>
  <div class="views-cluster-monitoring-namespaces">
    <div class="tab-select">
      ...
      <div>
        <span class="tab-select-title">{{
          $t("views.clusterMonitoring.creationTime")
        }}</span>
        <el-date-picker
      ...
      <div>
        <span class="tab-select-title">{{
          $t("views.clusterMonitoring.status")
        }}</span>
        <el-select
    ...
    <el-pagination
      ...
      @current-change="changePage('tableData1')"
    ></el-pagination>
  </div>
</template>
  ...
  methods: {
    ...
    initMsg() {
      ...
      if (this[this.linTabData].sel !== undefined) {
        if (
          this[this.linTabData].sel.full_time === "" ||
          this[this.linTabData].sel.full_time === null
        ) {
          this[this.linTabData].sel.start_time = "";
          this[this.linTabData].sel.end_time = "";
        } else {
          this[this.linTabData].sel.start_time =
            this[this.linTabData].sel.full_time[0] + " 00:00:00";
          this[this.linTabData].sel.end_time =
            this[this.linTabData].sel.full_time[1] + " 23:59:59";
        }
